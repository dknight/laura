...
---@field private after_function boolean
---@field private enabled boolean
local LineScanner = {}
LineScanner.__index = LineScanner

---Creates new LineScanner instance
...
function LineScanner:consume(line)
	...
	return excluded(any_hits_exclusions, simple_line),
		excluded(zero_hits_exclusions, simple_line)
end
